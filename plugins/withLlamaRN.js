// Local implementation of llama.rn config plugin
// Fixes CommonJS/ESM module resolution issues in the upstream package
// Implements the same functionality: entitlements, C++20 settings, Podfile modifications
...
const withLlamaRn = (config, options = {}) => {
  ...
  // Add iOS entitlements for extended memory when building for production
  const isProdProfile =
  ...
  // Force C++20 for llama.cpp compatibility
  if (forceCxx20) {
    ...
    // Modify Podfile to force C++20 on all pods
